...
public class MyRefactoringTest extends BaseTest {
    ...
    public void newInsuranceTest() throws Exception {
        ...
        assertTrue(String.format("Ожидаемый заголовок равен [%s]. Фактический заголовок - [%s]", expectedTitle, insurancePage.getTitle()),
                insurancePage.getTitle().contains(expectedTitle));
